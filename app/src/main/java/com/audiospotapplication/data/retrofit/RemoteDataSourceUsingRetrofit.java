...
public class RemoteDataSourceUsingRetrofit {
    ...
    public void resetPassword(String api_key,
        ...
        RestClient.getRetrofitService(api_key, lang, device_key)
                .resetPassword(email)
                .enqueue(new Callback<com.audiospotapplication.data.model.Response>() {
                    @Override
                    public void onResponse(Call<com.audiospotapplication.data.model.Response> call, Response<com.audiospotapplication.data.model.Response> response) {
                        callback.onSuccess(response.body());
                    }

                    @Override
                    public void onFailure(Call<com.audiospotapplication.data.model.Response> call, Throwable t) {
                        callback.onFailure(call, t);
                    }
                });
    }
