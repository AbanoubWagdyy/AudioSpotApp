...
//            openUi.putExtra("currentAudio", audio.id)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel =
                NotificationChannel(NOTIFICATION_CHANNEL, NOTIFICATION_CHANNEL, NotificationManager.IMPORTANCE_LOW)
...
//        remoteView.setOnClickPendingIntent(R.id.linear, buildHomePendingIntent())
    ...
    private fun buildHomePendingIntent(): PendingIntent {
        val configIntent = Intent(context, BookChaptersActivity::class.java)
